# To become an official maintainer for Project Zenith:
...
16. you must make use of all the opt-in features and device additions which can be found [here](https://github.com/ProjectZenithAOSP/Flags/blob/main/README.md).
...
If all is well, you may apply [here](https://github.com/ProjectZenithAOSP/Wiki/issues/new?template=device-maintainer-form.yml)

If you have any doubts/questions, make sure to contact the team on [Our Telegram Group](https://t.me/ProjectZenithChat)
